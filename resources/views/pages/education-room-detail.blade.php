            ...
            <div class="card-body">
                ...
                @if ($education_room->introduction_video_path)
                    ...
                    <video controls class="w-100 mb-3" style="max-height: 400px;">
                        <source src="{{ asset('storage/' . $education_room->introduction_video_path) }}" type="video/mp4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h6>Tujuan:</h6>
                        <p>{{ $education_room->purpose ?? '-' }}</p>
                    </div>
                    <div class="col-md-6">
                        <h6>Target:</h6>
                        <p>{{ $education_room->target ?? '-' }}</p>
                    </div>
                </div>
